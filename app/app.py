from sys import exception, prefix
from fastapi import FastAPI, HTTPException,File,UploadFile,Form,Depends,HTTPException
...
async def get_feed(
    ...
    user = [row[0] for row in result.all()]
    user_dict = {u.id:u.email for u in user}
